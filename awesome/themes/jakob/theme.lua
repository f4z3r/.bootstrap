...
theme.taglist_font                              = "Fira Code Regular 8"
...
local blue   = "#80CCE6"
local space3 = markup.font("Fira Code 3", " ")

-- Clock
local mytextclock = wibox.widget.textclock(markup("#FFFFFF", space3 .. "%H:%M " .. markup.font("Fira Code 4", " ")))
...
-- Calendar
local mytextcalendar = wibox.widget.textclock(markup.fontfg(theme.font, "#FFFFFF", space3 .. "%d %b" .. markup.font("Fira Code 5", " ")))
...
theme.fs = lain.widget.fs({
    notification_preset = { bg = theme.bg_normal, font = "Fira Code 9" },
    settings = function()
        widget:set_markup(markup.font(theme.font, "#80d9d8", string.format("%.1f", fs_now["/"].used) .. "% "))
    end
})
--]]
